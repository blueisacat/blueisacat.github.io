...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_0.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_1.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_2.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_3.png)

后来，我们为了合理利用资源和降低耦合性，于是把单系统拆分成多个子系统。

![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_4.png)

比如阿里系的淘宝和天猫，很明显地我们可以知道这是两个系统，但是你在使用的时候，登录了天猫，淘宝也会自动登录。

![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_5.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_6.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_7.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_8.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_9.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_10.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_11.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_12.png)
...
![](../../assets/images/Other/attachments/一图流(SSO,CAS,OAuth,OTP,JWT)_image_13.png)
