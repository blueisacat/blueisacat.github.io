...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_0.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_1.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_2.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_3.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_4.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_5.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_6.png)

接下来我们来简单看一下这个过程。

## TCP 流控：滑动窗口

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_7.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_8.png)

首先，发送端会一次性发 3 个 packets，将 1，2，3 发送给接收端，接收端接收到后会将这 3 个 packets 放到 Buffer 里去。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_9.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_10.png)

这时候发送端将 4，5，6 发送，接收端也能成功的接收到 Buffer 中去。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_11.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_12.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_13.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_14.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_15.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_16.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_17.png)

大体的逻辑就是从 Socket 里去接收数据，每 5s 去进行一次 WordCount，将这个代码提交后就进入到了编译阶段。

## 编译阶段：生成 JobGraph

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_18.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_19.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_20.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_21.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_22.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_23.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_24.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_25.png)

显然，再过不久 Socket 的 Buffer 也被用尽，这时就会将 Window = 0 发送给发送端（前文提到的 TCP 滑动窗口的机制）。这时发送端的 Socket 就会停止发送。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_26.png)

很快发送端的 Socket 的 Buffer 也被用尽，Netty 检测到 Socket 无法写了之后就会停止向 Socket 写数据。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_27.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_28.png)

这时候所有的压力都来到了 ResultSubPartition，和接收端一样他会不断的向 Local BufferPool 和 Network BufferPool 申请内存。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_29.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_30.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_31.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_32.png)

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_33.png)

# Flink Credit-based 反压机制（since V1.5）

## TCP-based 反压的弊端

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_34.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_35.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_36.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_37.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（7）：网络流控及反压剖析_image_38.png)
