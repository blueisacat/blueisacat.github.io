...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_0.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_1.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_2.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_3.png)

再比如下图 Input 指标正常都在四、五百万，突然跌成 0，这里也存在问题。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_4.png)

业务延时问题如下图，比如处理到的数据跟当前时间比对，发现处理的数据是一小时前的数据，平时都是处理一秒之前的数据，这也是有问题的。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_5.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_6.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_7.png)

利用 Metrics 缩小范围的方式如下图所示，就是用 Checkpoint Alignment 进行对齐，进而缩小范围，但这种方法用的较少。

![](../../assets/images/Flink/attachments/ApacheFlink进阶教程（8）：详解Metrics原理与实战_image_8.png)
