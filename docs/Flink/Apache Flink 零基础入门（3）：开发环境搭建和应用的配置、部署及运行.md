...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_0.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_1.png)

其中有三个文件可以留意一下：

![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_2.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_3.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_4.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_5.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_6.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_7.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（3）：开发环境搭建和应用的配置、部署及运行_image_8.png)
