...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_0.png)

然后在项目的 distribution 目录下我们就可以找到可执行程序了，包括两个压缩包，这两个压缩包就是nacos 的 github 官网上发布的 Release 包。

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_1.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_2.png)

启动成功后，我们就可以访问 Nacos 的控制台了，如下图所示：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_3.png)

控制台做了简单的权限控制，默认的账号和密码都是 nacos。

登录进去之后，是这样的：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_4.png)

## 1.3 新建配置

接下来我们在控制台上创建一个简单的配置项，如下图所示：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_5.png)

## 1.4 启动客户端

当服务端以及配置项都准备好之后，就可以创建客户端了，如下图所示新建一个 Nacos 的 ConfigService 来接收数据：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_6.png)

执行后将打印如下信息：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_7.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_8.png)

修改完配置，点击 “发布” 按钮后，客户端将会收到最新的数据，如下图所示：

![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_9.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_10.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_11.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_12.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_13.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_14.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_15.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_16.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_17.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_18.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_19.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_20.png)
...
![](../../assets/images/Nacos/attachments/2.Nacos配置中心原理分析_image_21.png)
