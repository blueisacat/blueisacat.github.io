...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_0.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_1.png)

然后我们启动客户端，观察打印的日志，如下图所示：

![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_2.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_3.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_4.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_5.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_6.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_7.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_8.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_9.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_10.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_11.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_12.png)

而 AbstractEventListener 是一个抽象类，所以实际注册的应该是 AbstractEventListener 的子类，所以我们需要找到所以继承自 AbstractEventListener 的类，如下图所示：


![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_13.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_14.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_15.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_16.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_17.png)
...
![](../../assets/images/Nacos/attachments/3.Nacos配置实时更新原理分析_image_18.png)
