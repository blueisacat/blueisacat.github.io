...
本以为在ArrayMetric中应该可以看到具体的统计操作了，谁知道又出现了一个叫 WindowLeapArray 的类，不过从名字上看有点 
...
![](../../assets/images/Sentinel/attachments/Sentinel原理（4）：滑动窗口_image_0.png)
...
![](../../assets/images/Sentinel/attachments/Sentinel原理（4）：滑动窗口_image_2.png)
