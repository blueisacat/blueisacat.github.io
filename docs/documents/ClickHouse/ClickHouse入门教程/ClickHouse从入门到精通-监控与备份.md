...
![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_0.png)
...
![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_1.png)
...
1. 点击配置，点击 `Data Sources` ：
    ...
    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_2.png)

2. 点击添加按钮：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_3.png)

3. 找到 `Prometheus` ，点击 `Select`

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_4.png)

4. 配置 `Prometheus Server` 地址：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_5.png)

5. 点击下方的 `Save&Test` ：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_6.png)

6. 出现绿色的提示框，表示与 `Prometheus` 正常联通：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_7.png)

7. 点击 `Back` 返回即可，可以看到 `Data Sources` 页面，出现了添加的 `Prometheus` ：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_8.png)
...
1. 点击左侧 `+` 号，选择 `import` ：
    ...
    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_9.png)

2. 上传 `JSON` 文件：

    ![](../../../assets/images/ClickHouse/ClickHouse入门教程/ClickHouse从入门到精通-监控与备份_image_10.png)
