...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_0.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_1.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_2.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_3.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_4.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_5.png)

流式处理简单来讲即有一个无穷无尽的数据源在持续收取数据，以代码作为数据处理的基础逻辑，数据源的数据经过代码处理后产生出结果，然后输出，这就是流式处理的基本原理。

## 4. 分布式流式处理

![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_6.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_7.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_8.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_9.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_10.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_11.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_12.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_13.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_14.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_15.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_16.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_17.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_18.png)

如图，Event – Time 相当于事件，它在数据最源头产生时带有时间戳，后面都需要用时间戳来进行运算。用图来表示，最开始的队列收到数据，每小时对数据划分一个批次，这就是Event – Time Process 在做的事情。

### 3.2 Event – Time 处理

![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_19.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_20.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_21.png)
...
![](../../assets/images/Flink/attachments/ApacheFlink零基础入门（1+2）：基础概念解析_image_22.png)
